...
VMMC_prep <- sim.results.prep %>% 
  ...
  summarize(CIRC_PREV_M1549_M = sum(Program_VMMC*pop.scaling.factor), .groups = "keep") %>% 
  group_by(Year) %>% 
...
ggplot() + 
  geom_point(
    data = VMMC_prep,
    mapping = aes(x = Year, y = CIRC_PREV_M1549_M), color = 'red') + 
  geom_errorbar(
    data = VMMC_prep,
    mapping = aes(x = Year, ymin = CIRC_PREV_M1549_95LL, ymax = CIRC_PREV_M1549_95UL), color = 'red') + 
  geom_point(
    data = VMMC_essential,
    mapping = aes(x = Year, y = CIRC_PREV_M1549_M), color = 'blue') +
  geom_errorbar(
    data = VMMC_essential,
    mapping = aes(x = Year, ymin = CIRC_PREV_M1549_95LL, ymax = CIRC_PREV_M1549_95UL), color = 'blue')
```
