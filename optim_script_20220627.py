...
BASE_POPULATION_SCALE_FACTOR = 0.01 # For quick test simulations, this is set to a very low value
N_ITERATIONS = 15
...
ingest_xlsm_filename = os.path.join('Data', 'calibration_ingest_form_ZWE_2022-07-15.xlsm') #'calibration_ingest_form_ZWE_2022-06-29.xlsm') 
